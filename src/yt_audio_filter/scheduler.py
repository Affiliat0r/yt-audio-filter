...
def run_daily_pipeline(
    ...
    # The shared pytubefix -> yt-dlp chain. download_youtube_video() is the
    # legacy YTDownloader.exe GUI path, which cannot run on a headless VM.
    from .youtube import download_video_with_metadata
    ...
    for i, (channel, video) in enumerate(all_selected, 1):
        ...
        try:
            with create_temp_dir(prefix="yt_scheduler_") as temp_dir:
                ...
                metadata = download_video_with_metadata(video.url, temp_dir)
